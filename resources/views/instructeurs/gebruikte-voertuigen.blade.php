...
<x-slot name="header">
    ...
    <div class="py-12">
        ...
        <a href="{{ route('instructeurs.gebruikte-voertuigen.create', $instructeur->id) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Toevoegen Voertuig</a>
